# VetMap — App Store Metadata

## App Name
- **zh-Hant-HK**: VetMap - 寵物醫院地圖
- **zh-Hans**: VetMap - 宠物医院地图
- **en**: VetMap - Pet Clinic Finder

## Subtitle (30 chars)
- **zh-Hant-HK**: 獸醫診所投稿與毛孩社群
- **zh-Hans**: 兽医诊所投稿与毛孩社区
- **en**: Vet Clinic Community
...
舊有 4 張 iPhone 及 4 張 iPad 截圖包含錯誤地區或過時內容，不可重用。必須以香港修正版 Xcode Cloud build 的真實 App 畫面重新截取：
