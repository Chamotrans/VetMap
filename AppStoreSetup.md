...
App Store Connect 現時的舊截圖包含已移除的商戶、保險及未授權診所內容，不可重用。Build 7 必須重新截取：

- 只展示 Build 7 真實 UI 及功能；
...
不能回答「No third-party content」。Build 7 沒有預載第三方目錄，但會顯示經批准的用戶內容：
...
5. 既有未能證明權利的第三方 dataset、商戶、保險、seed reviews／quotes 及自訂字型已從 Build 7 移除。
6. 完整邊界及來源研究見 [CONTENT_RIGHTS.md](CONTENT_RIGHTS.md)。
...
5. 推送權利安全修正，讓 workflow 建立 Build 7 Release Archive 並分發至 App Store Connect。
6. 安裝同一 Build 7 作真機 UGC／account deletion smoke test。
7. 將 processing 完成的 Build 7 掛接至 iOS 1.0。
